        ...
        if (r.name) {
          ...
          return `
            <div style="display:grid;grid-template-columns:repeat(${cols}, minmax(0,1fr));gap:${gap}px;align-items:stretch;">
              <div style="grid-column:span ${r.nameSpan};display:flex;align-items:center;font-weight:400;font-size:15px;color:var(--primary-text-color,#111827);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${this._esc(r.name)}</div>
